...
function ProjectCard({ project, bugs, onUpdate, onDelete }) {
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        description="This project will be permanently removed. Your bug entries will not be deleted but will no longer be linked to this project."
...
export default function Projects() {
  const { projects, addProject, updateProject, deleteProject, bugs } = useDebugStore()
